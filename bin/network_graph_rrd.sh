...
rrdtool graph --start -$age -v 'Contexts' -w 600 --slope-mode -t "Active MM Contexts" $RHIZO_DIR/graphs/mm_contexts-$age.png \
 DEF:pdpm=$RHIZO_DIR/mm_contexts.rrd:mm_contexts:AVERAGE \
 LINE1:pdpm#2AAAFF:"MM Contexts            " \

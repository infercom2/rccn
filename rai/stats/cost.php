...
$map = array('7d' => array(_('Last 7 Days').' - '._('Daily Total Calls Cost'),_('Day')),
	     '4w' => array(_('Last 4 Weeks').' - '._('Weekly Total Cost Usage'),_('Week year')),
	     'm' =>  array(_('Monthly Total Cost Usage'),_('Month')));
